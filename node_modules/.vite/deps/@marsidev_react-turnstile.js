...
var l = `https://challenges.cloudflare.com/turnstile/v0/api.js`, u = `cf-turnstile-script`, d = `cf-turnstile`, f = `onloadTurnstileCallback`, p = (e) => !!document.getElementById(e), m = ({ render: e = `explicit`, onLoadCallbackName: t = f, scriptOptions: { nonce: n = ``, defer: r = !0, async: i = !0, id: a = ``, appendTo: o, onError: s, crossOrigin: c = `` } = {} }) => {
...
}), b), S = (0, import_react.forwardRef)((e, l) => {
...
//#endregion
export { d as DEFAULT_CONTAINER_ID, f as DEFAULT_ONLOAD_NAME, u as DEFAULT_SCRIPT_ID, l as SCRIPT_URL, S as Turnstile };
