    ...
    <div>
      ...
      <div className="container pt-4">
        ...
        >
          ...
          {/* Banner Text */}
          <div className="position-relative z-1 p-4 p-md-5 d-flex flex-column justify-content-end h-100 text-white" style={{ minHeight: "280px" }}>
            <Eyebrow>Get in Touch</Eyebrow>
            <h1 className="font-serif display-5 fw-medium text-white mb-2" style={{ maxWidth: "600px" }}>
      ...
      <div className="container py-5">
        <div className="row g-5">
          ...
          <div className="col-12 col-lg-5">
            <h3 className="font-serif fs-3 fw-medium text-dark mb-4">Contact Information</h3>
            ...
            <div className="d-flex flex-column gap-4">
              ...
              <div className="d-flex align-items-center gap-3">
                ...
                <div className="text-break">
                  ...
                  <div className="fw-medium text-dark">ahmed.moussa.coaching@gmail.com</div>
                </div>
              </div>
